      ...
      <div className="how-we-encrypt-data">
        <Grid>
          <div className="content">
            <Row>
              <Col md={3} className="encrypt-graphic hidden-sm hidden-xs"><i className="fa fa-lock" aria-hidden="true"></i></Col>
              <Col md={9}>
                ...
                <Row>
                  <Col md={4}>
                    <IconColumn imageSrc="/img/icons/phone-white.png">
                      <DoesOrDoesnt value={true}>encrypt your data in the device or app</DoesOrDoesnt>
                    </IconColumn>
                  </Col>
                  <Col md={4}>
                    <IconColumn imageSrc="/img/icons/server-white.png">
                      <DoesOrDoesnt value={false} postText="if you take certain actions">encrypt your data when stored on our company servers</DoesOrDoesnt>
                    </IconColumn>
                  </Col>
                  <Col md={4}>
