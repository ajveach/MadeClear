...
import HorizontalList from '../dataDisplays/HorizontalList'
          ...
          <div className="content">
            ...
            <Row>
              ...
              <Col md={9}>
                ...
                <h3 className="segment-subtitle">
                  We <strong>do not</strong> sell your data AFTER removing identifiers to (note that remaining data may not be
                  anonymous):
                </h3>
                <ul>
                  <li>data brokers</li>
