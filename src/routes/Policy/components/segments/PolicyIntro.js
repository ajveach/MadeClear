  ...
  <div className="policy-intro policy-segment">
    <div className="container">
      <div className="content">
        ...
        <p>Please note that the health data we collect as part of this {props.params.productName} are not protected by HIPAA and our company’s HIPAA Notice of Privacy Practices does not apply.</p>
      </div>
    </div>
    <Scroll.Link className="scroll-arrow fa fa-arrow-down" aria-hidden="true" to="policy-use-share-sell" spy={true} smooth={true} duration={500}></Scroll.Link>
  </div>
)
